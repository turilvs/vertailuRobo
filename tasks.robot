...
#     @{values}=    Create list     ripuli    kyrpä    kusi
#     Set table cell    ${table}    1    0       ${values}[2]
#     Write table to CSV    table=${table}    path=/Users/Artturi/Koodaus/vertailuRobo/tulos.csv    delimiter=;
